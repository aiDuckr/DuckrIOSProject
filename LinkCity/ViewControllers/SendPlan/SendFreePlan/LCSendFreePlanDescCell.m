...
@interface LCSendFreePlanDescCell()<UITextViewDelegate>
@property (nonatomic, strong) UIButton *justClickedButton;

@end


@implementation LCSendFreePlanDescCell

//+ (instancetype)createInstance{
//    UINib *nib = [UINib nibWithNibName:NSStringFromClass([LCSendFreePlanDescCell class]) bundle:nil];
//    
//    NSArray *views = [nib instantiateWithOwner:nil options:nil];
//    for (UIView *v in views){
//        if ([v isKindOfClass:[LCSendFreePlanDescCell class]]) {
//            v.translatesAutoresizingMaskIntoConstraints = NO;
//            return (LCSendFreePlanDescCell *)v;
//        }
//    }
//    
//    return nil;
