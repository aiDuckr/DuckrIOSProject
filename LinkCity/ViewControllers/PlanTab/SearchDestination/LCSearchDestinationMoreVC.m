...
@implementation LCSearchDestinationMoreVC
+ (instancetype)createInstance {
    return (LCSearchDestinationMoreVC *)[LCStoryboardManager viewControllerWithFileName:SBNamePlanTab identifier:VCIDSearchDestinationMore];
}
