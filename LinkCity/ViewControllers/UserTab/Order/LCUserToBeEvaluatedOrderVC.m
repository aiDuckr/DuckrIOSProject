...
@interface LCUserToBeEvaluatedOrderVC ()<UITableViewDataSource, UITableViewDelegate, LCUserOrderCellDelegate>
...
@implementation LCUserToBeEvaluatedOrderVC

+ (instancetype)createInstance {
    return (LCUserToBeEvaluatedOrderVC *)[LCStoryboardManager viewControllerWithFileName:SBNameUserOrder identifier:VCIDUserToBeEvaluatedOrderVC];
}
...
- (void)requestUserToBeEvaluatedOrderFromOrderString {
    __weak typeof(self) weakSelf = self;
    [LCNetRequester getUserToBeEvaluatedOrder_V_FIVE:self.orderStr callBack:^(NSArray *planArray, NSArray *orderArray, NSString *orderStr, NSError *error) {
        if (error) {
...
- (void)headerRefreshing {
    self.orderStr = nil;
    [self requestUserToBeEvaluatedOrderFromOrderString];
}
