...
@protocol LCTextMessageToolBarDelegate;
@interface LCTextMessageToolBar : UIView

@property (nonatomic, weak) id <LCTextMessageToolBarDelegate> delegate;
...
@protocol LCTextMessageToolBarDelegate <NSObject>
