...
@interface LCTextMessageToolBar()<UITextViewDelegate, DXFaceDelegate>
{
...
@implementation LCTextMessageToolBar
...
//    allButtonWidth += CGRectGetWidth(self.faceButton.frame) + kHorizontalPadding * 1.5;
    ...
    _inputTextView.backgroundColor = UIColorFromR_G_B_A(242, 242, 242, 1);
...
//    self.recordButton.hidden = YES;
    ...
    self.inputTextView.layer.borderColor = UIColorFromR_G_B_A(232, 228, 221, 1).CGColor;
