...
{
    //ZLog(@"+ (XMPPMessage *)messageFromElement:(NSXMLElement *)element before from is %@", ((XMPPMessage *)element).from);
	object_setClass(element, [XMPPMessage class]);
    ZLog(@"+ (XMPPMessage *)messageFromElement:(NSXMLElement *)element end from is %@", ((XMPPMessage *)element).from);
	ZLog(@"+ (XMPPMessage *)messageFromElement:(NSXMLElement *)element end info is %@", ((XMPPMessage *)element).info);
