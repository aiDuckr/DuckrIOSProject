...
@interface CalendarViewController : LCBaseVC <CalendarLogicDelegate,UICollectionViewDataSource,UICollectionViewDelegate>
{
    UIView *confirmView;
}
...
@property (nonatomic, strong) NSArray *planStageArr;    // 邀约分期数据，by zzs
