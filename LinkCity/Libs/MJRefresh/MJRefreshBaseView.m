...
@interface  MJRefreshBaseView()
{
    ...
    __weak LCActivityIndicatorView *_activityView;
}
@end
...
{
    if (!_arrowImage) {
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"MJRefreshArrow"]];
 ...
 *  状态标签
 */
- (LCActivityIndicatorView *)activityView
{
    if (!_activityView) {
//        UIActivityIndicatorView *activityView = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
        LCActivityIndicatorView *activityView = [[LCActivityIndicatorView alloc]init];
...
//    // 1.箭头
//    CGFloat arrowX = self.mj_width * 0.5 - 50;
