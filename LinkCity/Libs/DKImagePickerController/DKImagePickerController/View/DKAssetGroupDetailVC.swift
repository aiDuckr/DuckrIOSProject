...
internal class DKAssetGroupDetailVC: UICollectionViewController, DKGroupDataManagerObserver {
    ...
    class DKAssetCell: UICollectionViewCell {
        ...
        class DKImageUnCheckView: UIView {
            private lazy var unCheckImageView: UIImageView = {
                let imageView = UIImageView(image: DKImageResource.unCheckedImage())
                return imageView;
            }()
            ...
            override func layoutSubviews() {
                ...
                self.unCheckImageView.frame = self.bounds
            }
        }
        ...
        class DKImageCheckView: UIView {
            ...
            private lazy var checkLabel: UILabel = {
                ...
                label.textColor = LCSSharedFuncUtil.colorFromRGBA(0x6b450a, alpha: 1.0)
            ...
            override func layoutSubviews() {
                ...
                self.checkLabel.frame = CGRect(x: 0.0, y: 0.0, width: self.bounds.width * 0.2, height: self.bounds.height * 0.2)
                self.checkLabel.center = CGPoint(x: self.bounds.width * 0.782, y: self.bounds.height * 0.1935)
            }
        ...
        private let unCheckView = DKImageUnCheckView()
        private let checkView = DKImageCheckView()
        
        override var selected: Bool {
            didSet {
                checkView.hidden = !super.selected
                unCheckView.hidden = super.selected
            }
        }
        ...
        override init(frame: CGRect) {
            ...
            self.contentView.addSubview(unCheckView)
        }
        ...
        override func layoutSubviews() {
            ...
            unCheckView.frame = self.thumbnailImageView.frame
        }
